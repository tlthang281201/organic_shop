        ...
        <div class="row">
                        ...
                        @foreach($latestBlog as $item)
                            <div class="recent_post mb-30">
                                <div class="recent_post_title">
                                    <a href="blog/{{ $item->alias }}"><img src="front/blog/{{ $item->thumb }}" alt=""></a>    
                                </div>
                                <div class="recent_post_content">
                                    <h4><a href="blog/{{ $item->alias }}">{{ $item->title }}</a></h4>
                                    <span class="post_date">{{ date('d/m/Y', strtotime($item->create_date)) }}</span>   
                                </div>   
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="blog_details_info">
                    <div class="blog_meta">
                        <ul>
                            <li>{{ date('d/m/Y', strtotime($blog->create_date)) }}</li>
                        </ul>   
                    </div>
                    <h3>{{ $blog->title }}</h3> 
                    <div class="blog_details_img">
                        <img src="front/blog/{{ $blog->thumb }}" alt="" width="770px">    
                    </div>   
...
<div class="footer_food_wrapper ">         
    <!-- footer start -->
    <footer class="footer pt-90 blog">
        <div class="container-fluid">
            <div class="row">
