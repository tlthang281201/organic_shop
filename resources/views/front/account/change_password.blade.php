            ...
            <div class="row">
                <div class="col-sm-12 col-md-3 col-lg-3">
                    ...
                    <ul role="tablist" class="nav flex-column dashboard-list">
                        ...
                        <li><a href="thong-tin-ca-nhan/doi-mat-khau" class="nav-link active">Thay đổi mật khẩu</a></li>
                        <li><a href="log-out" onclick="event.preventDefault();
                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <div class="tab-content dashboard-content">
                        <div class="tab-pane show active" id="change-password">
                            ...
                            <div class="login-form-container">
                                <div class="account-login-form">
                                    <form action="thong-tin-ca-nhan/doi-mat-khau" method="POST">
                                        @csrf
                                        <div style="margin-bottom: 20px">
                                            <label>Mật khẩu cũ</label>
                                            <input style="margin-bottom: 0px;" type="password" name="old_password" required >
                                        ...
                                        <div style="margin-bottom: 20px">
                                            ...
                                            <input type="password" name="password" required  style="margin-bottom: 0px">
                                        ...
                                        <div style="margin-bottom: 20px">
                                            ...
                                            <input type="password" name="password_confirmation" required  style="margin-bottom: 0px">
