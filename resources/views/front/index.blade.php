    ...
    <div class="shipping_area">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div
              class="shipping_list d-flex justify-content-between flex-xs-column"
            >
    ...
    <div class="recommended_product">
      <div class="container-fluid">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="banana" role="tabpanel">
            <div class="row">
              <div class="features_product_active owl-carousel">
                <div class="col-lg-2">
                  <div class="single__product">
            ...
            <div class="best_selling_product_list owl-carousel">
              ...
              <div class="best_selling_product">
                <div class="single_small_product mb-30">
                  ...
                  <div class="product_content">
                    <h4>
                      <a href="product-details.html">Cheese Butter Burger</a>
                    </h4>
                    <div class="product_ratting">
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
              ...
              <div class="best_selling_product">
                <div class="single_small_product mb-30">
                  ...
                  <div class="product_content">
                    <h4>
                      <a href="product-details.html">Chaz Kangeroo Hoodie3</a>
                    </h4>
                    <div class="product_ratting">
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
