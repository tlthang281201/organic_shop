              ...
              <form action="" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" minlength="10" maxlength="10" class="form-control" id="exampleInputEmail1" name="code" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" minlength="1" class="form-control" id="exampleInputEmail1" name="value" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Giảm tối đa</label>
                    <input type="number" class="form-control" id="exampleInputEmail1" name="max_discount">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Điều kiện đơn hàng trên bao nhiêu tiền</label>
                    <input type="number" minlength="1" class="form-control" id="exampleInputEmail1" name="total_order" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Ngày hết hạn</label>
                    <input type="date" minlength="3" class="form-control" id="exampleInputEmail1" name="expire_date" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Số lượng</label>
                    <input type="number" min="0" class="form-control" id="exampleInputEmail1" name="quantity" required>
                  </div>
                </div>
                <!-- /.card-body -->
