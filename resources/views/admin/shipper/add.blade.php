          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <h3 class="card-title">Thêm người giao hàng</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" minlength="5" class="form-control" id="exampleInputEmail1" name="name" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Số điện thoại</label>
                    <input type="text" minlength="10" maxlength="10" class="form-control" id="exampleInputPassword1" name="phone" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Địa chỉ</label>
                    <input type="text" minlength="5" class="form-control" id="exampleInputPassword1" name="address" required>
                  </div>
                  <div class="form-group">
